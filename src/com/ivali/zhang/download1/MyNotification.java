...
public class MyNotification {
     ...
     */
    public void showCustomizeNotification(int icoId,String title,String apkname,int layoutId) {  
        this.titleStr=title;
        ...
        if(remoteView==null)
        {
            ...
            remoteView.setImageViewResource(R.id.icon,icoId);  
            remoteView.setTextViewText(R.id.down_apkname, apkname); 
            remoteView.setTextViewText(R.id.down_state_tv, "开始下载"); 
            remoteView.setTextViewText(R.id.down_progress_tv, "0%"); 
            remoteView.setProgressBar(R.id.pb, 100, 0, false);
    ...
    public void changeProgressStatus(int p)
    {
        ...
        {
            if(p==-1){
            	notification.contentView.setTextViewText(R.id.down_state_tv , "下载失败： "); 
            	 notification.contentView.setTextViewText(R.id.down_progress_tv , "下载失败，请重试"); 
            }
                
            else if(p==100){
            	  notification.contentView.setViewVisibility(R.id.pb, View.GONE);
            	  notification.contentView.setTextViewText(R.id.down_state_tv , "下载完成："); 
                  notification.contentView.setTextViewText(R.id.down_progress_tv , "下载完成，请点击安装"); 
             
            } else{
            	notification.contentView.setTextViewText(R.id.down_state_tv , "正在下载："); 
                notification.contentView.setTextViewText(R.id.down_progress_tv , "当前进度：("+p+"%) "); 
                notification.contentView.setProgressBar(R.id.pb, 100, p, false);
            }
